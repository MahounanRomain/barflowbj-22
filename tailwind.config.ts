...
export default {
	...
	theme: {
      ...
      animation: {
        ...
        'fade-in': 'fade-in 1.6s cubic-bezier(0.16, 1, 0.3, 1)',
        'fade-in-up': 'fade-in-up 2s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-in-right': 'slide-in-right 1.4s cubic-bezier(0.16, 1, 0.3, 1)',
        'slide-in-left': 'slide-in-left 1.4s cubic-bezier(0.16, 1, 0.3, 1)',
        'scale-in': 'scale-in 1.2s cubic-bezier(0.16, 1, 0.3, 1)',
        'gentle-bounce': 'gentle-bounce 5s ease-in-out infinite',
        'float': 'float 8s ease-in-out infinite',
        'shimmer': 'shimmer 3.6s ease-out',
