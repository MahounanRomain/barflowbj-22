    ...
    <div className="mb-8">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-muted-foreground">
            Personnalisez BarFlow selon vos besoins
            {hasUnsavedChanges && (
              <span className="ml-2 text-orange-600 font-medium">• Modifications en cours</span>
            )}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 p-6 bg-gradient-to-r from-accent/10 to-primary/10 rounded-xl border border-primary/20 shadow-sm">
        <div className="text-center">
          ...
          <div className="text-xs text-muted-foreground">Articles en stock</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-accent">{salesCount}</div>
          <div className="text-xs text-muted-foreground">Ventes enregistrées</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-secondary bg-inherit">{staffCount}</div>
          <div className="text-xs text-muted-foreground">Membres d'équipe</div>
        </div>
      </div>
    </div>
  );
